                            ...
                            Expanded(
                              child: Padding(
                                ...
                                child: GridView.builder(
                                    ...
                                    itemCount: state.getGiftModel.data!.length,
                                    itemBuilder: (BuildContext ctx, index) {
                                      ...
                                      return InkWell(
                                        ...
                                        child: Container(
                                          decoration: BoxDecoration(
                                            border:Border.all(
                                              color:giftId==index?ColorManager.primaryColor:
                                              ColorManager.backgroundColor,
                                            ),
                                            ...
                                            child: Column(
                                              ...
                                              children: [
                                                CachedNetworkImage(
                                                  ...
                                                  imageUrl: state.getGiftModel.data![index].img!,
                                                  width: 33.w,
                                                  height: 33.w,
                                                  imageBuilder: (context, imageProvider) => Container(
                                                    decoration: BoxDecoration(
                                                ...
                                                Row(
                                                  ...
                                                  children: [
                                                    ...
                                                    Text(state.getGiftModel.data![index].price!,
                                                      style: TextStyle(
                                                        fontSize: 14.sp,
                                                        fontFamily: 'DIN',
